...
a=[]
a1 = 0.0001 * np.ones((1, 3, 10, 10), np.float64)
a2 = 0.000001 * np.ones((1, 3, 10, 10), np.float64)
a3 = 0.00000001 * np.ones((1, 3, 10, 10), np.float64)
# a.append(a1)
# a.append(a2)
# a.append(a3)
...
def Max_guided(corpus,f,g):
    ...
    while not corpus.empty() and j<20000:
        ...
        # getMaxdiff(x + a1, csv_writer, j, "e-4", err,err1)
        # getMaxdiff(x + a2, csv_writer, j, "e-6", err,err1)
        # getMaxdiff(x + a3, csv_writer, j, "e-8", err,err1)
        if maxe1>maxine1:
            index1=j
            maxine1=maxe1 #最大误差
...
def getMaxdiff(x,csv_writer,j):
    ...
    out_32_16_1=tf_conv_16(x_32)
    out_64_16_1=tf_conv_16(x_64)
...
if __name__=='__main__':
    ...
    Max_guided(corpus,"D:/da3/自动化测试/predoo/max_guided_data/tf_gpu_2.0.0/conv2d.csv","D:/da3/自动化测试/predoo/max_guided_data/tf_gpu_2.0.0/conv2d_count.csv")
    Mean_guided(corpus,"D:/da3/自动化测试/predoo/mean_guided_data/tf_gpu_2.0.0/conv2d.csv","D:/da3/自动化测试/predoo/max_guided_data/tf_gpu_2.0.0/conv2d_count.csv")
